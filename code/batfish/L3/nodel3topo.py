...
Description:
------------
    Consists of the NodeL3Topo class which queries the batfish service
    for Layer3 topology of the node. Calculates possible mismatches
    related to the Layer 3 Interfaces.
